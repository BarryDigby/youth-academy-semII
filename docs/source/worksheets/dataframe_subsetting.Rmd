...
For this exercise you will work with a Stroke Dataset, which has work, maritial status and some clinical variables recorded such as glucose levels, bmi etc. The variable stroke indicates if the patient has had a stroke. 

If you are twinkly eyes, you might use these kinds of datasets for finding patterns that help identify fututre strokes in new patients before they happen. 
